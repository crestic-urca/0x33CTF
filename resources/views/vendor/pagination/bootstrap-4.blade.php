    ...
    <ul class="pagination">
        ...
        @else
            <li class="waves-effect">
                <a class="" href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')"><i class="material-icons">chevron_left</i></a>
            </li>
        @endif
        ...
        @else
            <li class="disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                <span class="" aria-hidden="true"><i class="material-icons">chevron_right</i></span>
            </li>
        @endif
    </ul>
