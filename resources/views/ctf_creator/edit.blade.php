...
@section('contenu')
    ...
    <div class="parallax-container valign-wrapper" style="height: 150px">
        ...
        <div class="container center-align">
            <h2 style="margin: 0">Edit my challenges</h2>
        </div>
    </div>
    <!-- /Header -->
	...
	<div class="container">
        ...
        <div class="card blue-grey darken-3 hoverable">
            <div class="card-content">
                <div class="card-title center">Edit the challenge "{{ $sujet->titre }}"</div>       

                    {!! Form::model($sujet,['route' => ['subjects.update',$sujet->id], 'method' => 'put','files' => 'true']) !!}
                        @csrf
                        <div class="input-field {!! $errors->has('titre') ? 'has-error' : '' !!}">
                                <i class="material-icons prefix">create</i>
                                {!! Form::text('titre', null, ['id'=>'titre','class' => 'validate']) !!}
                                {!! Form::label('titre', "Title") !!}
                                {!! $errors->first('titre', '<small class="help-block">:message</small>') !!}
                        </div>
                        <div class="input-field {!! $errors->has('enonce') ? 'has-error' : '' !!}">
                        ...
                        <div class="input-field {!! $errors->has('categorie_id') ? 'has-error' : '' !!}">
                        ...
                        <div class="input-field {!! $errors->has('nb_points') ? 'has-error' : '' !!}">
                        ...
                        <div class="file-field input-field {!! $errors->has('file_attachment') ? 'has-error' : '' !!}">
                            <div class="btn">
